...
- Weisfeiler–Leman color refinement disambiguates property-twin / attribute-less definer cases and is the default (`id_disambiguation="wl"`); see the Referential Alignment section above. `research/FUTURE.md` tracks the remaining doors (callable strategy protocol, `ref_informed`, `k_wl`, graded `w`).
